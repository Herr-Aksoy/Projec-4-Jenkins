...
resource "aws_iam_role" "ec2fulltoecr" {
  name = "oliverec2roletoecr"           ## Rollerin isimlerini degistirebiliriz
...
resource "aws_instance" "docker-machine-leader-manager" {
  ...
  tags = {
    Name = "oliver-Docker-Swarm-Leader-Manager"   ## Taglar degistirilebilir
    server = "docker-grand-master"              ##bu kisim degistirilmemeli bagli
    project = "205"
  }
}
